...
completeInfo = completeInfo[completeInfo['player_id'] == '1'] #****CHANGE THIS TO FILTER SPECIFIC PLAYERS ONLY - OTHER PLAYERS WILL AFFECT DATA
...
predictionY = model.predict([[1, 0.646, 1]]) #0 = Home, 1 = Away
